...
module.exports = {
    ...
    CreateMessageValidator: [
        body("to")
            .notEmpty()
            .withMessage("to khong duoc de trong")
            .bail()
            .isMongoId()
            .withMessage("to khong hop le"),
        body("messageContent")
            .isObject()
            .withMessage("messageContent phai la object"),
        body("messageContent.type")
            .notEmpty()
            .withMessage("messageContent.type khong duoc de trong")
            .bail()
            .isIn(["text", "file"])
            .withMessage("messageContent.type phai la text hoac file"),
        body("messageContent.text")
            .notEmpty()
            .withMessage("messageContent.text khong duoc de trong")
            .bail()
            .isString()
            .withMessage("messageContent.text phai la chuoi")
    ]
}